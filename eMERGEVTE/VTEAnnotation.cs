...
namespace eMERGEVTE
{
    ...
    {
        #region Constants
        public const string DocumentVTEFindingsTag = "DocumentVTEFindings";
        ...
        public override void LoadAnnotations(string file, List<Document> documents)
        {
            ...
            //            currentDocument.Annotations.Add(DocumentVTEFindingsTag, findings);
            //            if (fields.Length > 4)
            //            {
        ...
        public override void SaveAnnotations(string file, List<Document> documents)
        {
            ...
            //           );
            //        List<Finding> findings = document.Annotations[DocumentVTEFindingsTag] as List<Finding>;
